...
REM Fresh GitHub zip may be "finance-manager-main (1)". "%~dp0." handles
...
echo Building Finance Manager Windows installers...
...
:noroots
echo ERROR: This is not the Finance Manager folder.
