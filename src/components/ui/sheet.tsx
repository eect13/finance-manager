  ...
  return (
    <SheetPrimitive.Portal>
      ...
      <SheetPrimitive.Content
        className={cn(
          "fixed z-50 flex h-dvh max-h-dvh w-[min(18rem,100%)] min-h-0 flex-col overflow-hidden bg-sidebar text-sidebar-foreground overscroll-contain pt-[max(2.75rem,env(safe-area-inset-top,0px))] pb-[max(1.25rem,env(safe-area-inset-bottom,0px))]",
